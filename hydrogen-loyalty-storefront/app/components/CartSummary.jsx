 ...
 */
export function CartSummary({cart, layout, loyalty}) {
  const className =
    layout === 'page' ? 'cart-summary-page' : 'cart-summary-aside';
  const showAdjustmentForms = layout === 'page';
    ...
    <div aria-labelledby={summaryId} className={className}>
      ...
      {showAdjustmentForms ? (
        <>
          ...
          />
          <LoyaltyRewards cart={cart} loyalty={loyalty} />
        </>
      ) : null}
...
function CartCheckoutActions({checkoutUrl}) {
  ...
  return (
    <div className="cart-checkout-actions">
      <a className="cart-checkout-actions__button" href="/checkout" target="_self">
