...
type Module = typeof import("../api.customer-reward-history.js")

type Info = GetInfo<{
  file: "routes/api.customer-reward-history.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.customer-reward-history.js");
}];
