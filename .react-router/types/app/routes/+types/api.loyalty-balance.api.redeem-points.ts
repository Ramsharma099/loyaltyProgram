...
type Module = typeof import("../api.loyalty-balance.api.redeem-points.js")

type Info = GetInfo<{
  file: "routes/api.loyalty-balance.api.redeem-points.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.loyalty-balance.api.redeem-points.js");
}];
