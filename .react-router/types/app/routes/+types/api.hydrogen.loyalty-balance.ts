...
type Module = typeof import("../api.hydrogen.loyalty-balance.js")

type Info = GetInfo<{
  file: "routes/api.hydrogen.loyalty-balance.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.hydrogen.loyalty-balance.js");
}];
