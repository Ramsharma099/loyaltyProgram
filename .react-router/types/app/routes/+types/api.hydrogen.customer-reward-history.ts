...
type Module = typeof import("../api.hydrogen.customer-reward-history.js")

type Info = GetInfo<{
  file: "routes/api.hydrogen.customer-reward-history.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.hydrogen.customer-reward-history.js");
}];
